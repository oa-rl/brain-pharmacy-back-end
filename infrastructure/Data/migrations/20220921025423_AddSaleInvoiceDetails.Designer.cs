...
namespace Infrastructure.Data.migrations
{
    ...
    [Migration("20220921025423_AddSaleInvoiceDetails")]
    partial class AddSaleInvoiceDetails
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Entities.SaleInvoiceDetailsEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Core.Entities.SaleInvoiceEntity", b =>
                {
                    ...
                    b.Property<int?>("SaleInvoiceDetailsId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("SaleInvoiceDetailsId");
            ...
            modelBuilder.Entity("Core.Entities.ProductMovementEntity", b =>
                {
                    b.HasOne("Core.Entities.OperationTypeEntity", "Operationtype")
                        .WithMany()
            ...
            modelBuilder.Entity("Core.Entities.SaleInvoiceEntity", b =>
                {
                    b.HasOne("Core.Entities.CustomerEntity", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Core.Entities.SaleInvoiceDetailsEntity", "SaleInvoiceDetails")
                        .WithMany()
                        .HasForeignKey("SaleInvoiceDetailsId");
